...
<footer class="footer">
  <div class="footer-left">
    ...
    <p>
      ...
      esteemed writers. Make sure to read up and keep up with us through this platform that we bring to you. The Bharat
    </p>
    <div class="socials">
  ...
  <ul class="footer-right">
    ...
    <li>
      ...
      <ul class="box">
        <li>
          Share the story in your own words with the world. To Inspire with your writing make The Bharat your platform to
  ...
  <div class="footer-bottom">
    <p>All Rights Reserved by &copy; The Bharat <?php echo date("Y")?></p>
  </div>
</footer>
